...
RETURN_TYPE Resolver::visit(const Literal &expr) { return nullptr; }
...
// Stmt
void Resolver::visit(const Expression &stmt) { resolve(stmt.expr); }
void Resolver::visit(const Print &stmt) { resolve(stmt.expr); }
