...
void Lexer::LexerImp::scanToken()
{
    ...
    switch(c) {
        ...
        case '?': addToken(TokenType::QUESTION_MASK);break;
...
bool Lexer::LexerImp::isDigit(char c)
{
    return c >= '0' && c<='9';
}
...
void Lexer::LexerImp::addToken(TokenType type)
{
...
vector<shared_ptr<Token>> Lexer::scanTokens()
{
